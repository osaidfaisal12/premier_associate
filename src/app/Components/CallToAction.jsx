...
const CallToAction = () => {
  return (
    ...
    <h2 className='font-secularOne xl:max-w-[750px] max-w-[600px] text-white md:text-[32px] text-[24px] lg:text-left text-center'>Building bridges between you and your Key Accounts. The &ldquo;T I M E&rdquo; is NOW. Contact Us Now!</h2>
