...
const CallToAction = () => {
  return (
    ...
    <h2 className='font-secularOne xl:max-w-[750px] max-w-[600px] text-white md:text-[32px] text-[24px] lg:text-left text-center'>Don't let tasks pile up. Contact us to get your virtual assistant support in motion.</h2>
