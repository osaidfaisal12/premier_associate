    ...
    <div className="flex lg:py-[90px] py-[60px] lg:leading-[250%] lg:tracking-[0.5px] xl:pl-[243px] lg:pl-[180px] md:pl-[65px] pl-[35px] md:pr-0 pr-[30px]">
      ...
      <div>
        ...
        <ul style={{ listStyleType: 'inherit' }} className="ml-4 font-poppins">
          ...
          <li>More time to focus on core business strategies and growth.</li>
          <li>
            Cost savings by eliminating the overhead of full-time employees.
          </li>
          <li>Scalable solutions that adapt to your changing requirements.</li>
        </ul>
      </div>
      <br />
      <p className="font-poppins">
